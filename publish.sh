...
echo "  https://github.com/nickprotop/cxshell/actions"
echo ""
echo "Release will be at:"
echo "  https://github.com/nickprotop/cxshell/releases/tag/$NEW_TAG"
